...
grep 'norvegicus' /localdisk/home/bjackso4/rattus_norvegicus_FASTQ/sample_file_table.txt |\
  cut -f5 | cut -d';' -f1 | rev | cut -d'/' -f1 | rev | cut -d'_' -f1 | sort | uniq | {
    ...
    do
      ...
      echo "nice -n 19 ./run_mapping.sh ${REFERENCE} /localdisk/home/bjackso4/rattus_norvegicus_FASTQ/${INFILE_1} /localdisk/home/bjackso4/rattus_norvegicus_FASTQ/${INFILE_2} ${ID} ${LB} ${SM} ${OUTFILE}" >> commands.txt
